# Design System: GoldTrust Imperial Holdings
...
The "Luxury Noir" theme balances GoldTrust Imperial Holdings' institutional trust with the exclusivity of private banking. It uses a near-black foundation to eliminate visual noise, allowing the user's capital and performance data to remain the primary focus. High-contrast negative space and hairline borders create a sense of precision and "weight."
